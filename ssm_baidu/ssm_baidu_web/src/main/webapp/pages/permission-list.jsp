            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="新建" onclick="subForm()">
                        ...
                        <!--数据列表-->
                        <form id="subFormId" action="${pageContext.request.contextPath}/permission/deleteByIds.do" method="post">
                            <table id="dataList"
                                ...
                                <c:forEach items="${permissions}" var="p">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="${pageContext.request.contextPath}/permission/echo.do?id=${p.id}"
